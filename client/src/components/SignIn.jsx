...
export default function SignIn() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen  flex flex-col justify-center sm:px-6 lg:px-8 bg-[color:var(--backGround-color-light)] dark:bg-[color:var(--backGround-color-dark)]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 ">
            <div>
              ...
              <input
                ...
                className="appearance-none text-white dark:text-black block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                id="email"
